...
public enum ErrorCode {
    ...
    COOKIE_DELETE_FAILURE(10008, "存在还在领取中的红包不允许删除 Cookie！"),
    COOKIE_DELETE_EXCEPTION(10009, "可用次数不足5次，不允许删除 Cookie！"),
    ...
    RECEIVE_LOCKED(10014, "由于您在其他地方使用了所贡献的 Cookie 次数，所以已被限制领取，请先阅读规则，愿意承诺遵守规则之后联系管理员解除限制！涉及以下小号："),
    AVAILABLE_INSUFFICIENT(10015, "美团或饿了么的可用次数不足（小于2次），不能领取对应的红包！"),
